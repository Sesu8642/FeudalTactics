...
public class EditorController {
	...
	public void generateEmptyGameState() {
		...
		players.add(new Player(GameController.playerColors[0], Type.LOCAL_PLAYER));
		for (int i = 1; i < GameController.playerColors.length; i++) {
			players.add(new Player(GameController.playerColors[i], Type.LOCAL_BOT));
		}
