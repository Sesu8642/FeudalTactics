...
public class Slide {
    ...
    public Slide addImage(String imagePath) {
        final Texture imageTexture = new Texture(Gdx.files.internal(imagePath));
        final Image image = new Image(imageTexture);
        final float aspectRatio = ((float) imageTexture.getHeight()) / imageTexture.getWidth();
