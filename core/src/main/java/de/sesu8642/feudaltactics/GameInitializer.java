...
public class GameInitializer {
    ...
    void initializeGame() {
        ...
        try {
            ...
            final InputStream stream = GameInitializer.class.getClassLoader().getResourceAsStream("logging.properties");
        ...
        try {
            ...
            final String previousVersion = gameVersionDao.getGameVersion();
